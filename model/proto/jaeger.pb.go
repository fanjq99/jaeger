...
type KeyValue struct {
	Key     string    `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	VType   ValueType `protobuf:"varint,2,opt,name=vType,proto3,enum=ValueType" json:"vType,omitempty"`
...
type SpanRef struct {
	...
	Type    SpanRefType `protobuf:"varint,3,opt,name=type,proto3,enum=SpanRefType" json:"type,omitempty"`
}
...
func init() {
	proto.RegisterType((*TraceID)(nil), "TraceID")
	golang_proto.RegisterType((*TraceID)(nil), "TraceID")
	proto.RegisterType((*SpanID)(nil), "SpanID")
	golang_proto.RegisterType((*SpanID)(nil), "SpanID")
	proto.RegisterType((*KeyValue2)(nil), "KeyValue2")
	golang_proto.RegisterType((*KeyValue2)(nil), "KeyValue2")
	proto.RegisterType((*KeyValue)(nil), "KeyValue")
	golang_proto.RegisterType((*KeyValue)(nil), "KeyValue")
	proto.RegisterType((*Log)(nil), "Log")
	golang_proto.RegisterType((*Log)(nil), "Log")
	proto.RegisterType((*SpanRef)(nil), "SpanRef")
	golang_proto.RegisterType((*SpanRef)(nil), "SpanRef")
	proto.RegisterType((*Process)(nil), "Process")
	golang_proto.RegisterType((*Process)(nil), "Process")
	proto.RegisterType((*Span)(nil), "Span")
	golang_proto.RegisterType((*Span)(nil), "Span")
	proto.RegisterType((*Trace)(nil), "Trace")
	golang_proto.RegisterType((*Trace)(nil), "Trace")
	proto.RegisterType((*Batch)(nil), "Batch")
	golang_proto.RegisterType((*Batch)(nil), "Batch")
	proto.RegisterEnum("ValueType", ValueType_name, ValueType_value)
	golang_proto.RegisterEnum("ValueType", ValueType_name, ValueType_value)
	proto.RegisterEnum("SpanRefType", SpanRefType_name, SpanRefType_value)
	golang_proto.RegisterEnum("SpanRefType", SpanRefType_name, SpanRefType_value)
}
...
type CollectorServiceV1Client interface {
	SaveBatch(ctx context.Context, in *Batch, opts ...grpc.CallOption) (*google_protobuf.Empty, error)
}
...
func (c *collectorServiceV1Client) SaveBatch(ctx context.Context, in *Batch, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
	err := grpc.Invoke(ctx, "/CollectorServiceV1/SaveBatch", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CollectorServiceV1Server interface {
	SaveBatch(context.Context, *Batch) (*google_protobuf.Empty, error)
}
...
func _CollectorServiceV1_SaveBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Batch)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CollectorServiceV1Server).SaveBatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CollectorServiceV1/SaveBatch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollectorServiceV1Server).SaveBatch(ctx, req.(*Batch))
	}
	return interceptor(ctx, in, info, handler)
}

var _CollectorServiceV1_serviceDesc = grpc.ServiceDesc{
	ServiceName: "CollectorServiceV1",
	HandlerType: (*CollectorServiceV1Server)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SaveBatch",
			Handler:    _CollectorServiceV1_SaveBatch_Handler,
		},
	},
...
type QueryServiceV1Client interface {
	GetTrace(ctx context.Context, in *TraceID, opts ...grpc.CallOption) (*Trace, error)
}
...
func (c *queryServiceV1Client) GetTrace(ctx context.Context, in *TraceID, opts ...grpc.CallOption) (*Trace, error) {
	out := new(Trace)
	err := grpc.Invoke(ctx, "/QueryServiceV1/GetTrace", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServiceV1Server interface {
	GetTrace(context.Context, *TraceID) (*Trace, error)
}
...
func _QueryServiceV1_GetTrace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/QueryServiceV1/GetTrace",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServiceV1Server).GetTrace(ctx, req.(*TraceID))
	}
	return interceptor(ctx, in, info, handler)
}

var _QueryServiceV1_serviceDesc = grpc.ServiceDesc{
	ServiceName: "QueryServiceV1",
...
var fileDescriptorJaeger = []byte{
	...
	,
}
