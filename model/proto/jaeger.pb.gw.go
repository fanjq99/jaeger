...
func request_CollectorServiceV1_SaveBatch_0(ctx context.Context, marshaler runtime.Marshaler, client CollectorServiceV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Batch
	...
	msg, err := client.SaveBatch(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

var (
	filter_QueryServiceV1_GetTrace_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_QueryServiceV1_GetTrace_0(ctx context.Context, marshaler runtime.Marshaler, client QueryServiceV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TraceID
	var metadata runtime.ServerMetadata

	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_QueryServiceV1_GetTrace_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterCollectorServiceV1HandlerClient(ctx context.Context, mux *runtime.ServeMux, client CollectorServiceV1Client) error {
	...
	mux.Handle("POST", pattern_CollectorServiceV1_SaveBatch_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CollectorServiceV1_SaveBatch_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_CollectorServiceV1_SaveBatch_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_CollectorServiceV1_SaveBatch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "traces"}, ""))
)

var (
	forward_CollectorServiceV1_SaveBatch_0 = runtime.ForwardResponseMessage
)
...
var (
	pattern_QueryServiceV1_GetTrace_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "traces"}, ""))
)
